 ...
 * generated in the com.bharath.ws.soap package. 
...
public class ObjectFactory {
    ...
    private final static QName _ProcessPayment_QNAME = new QName("http://soap.ws.bharath.com/", "processPayment");
    private final static QName _ProcessPaymentResponse_QNAME = new QName("http://soap.ws.bharath.com/", "processPaymentResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.bharath.ws.soap
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.ws.bharath.com/", name = "processPayment")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.ws.bharath.com/", name = "processPaymentResponse")
